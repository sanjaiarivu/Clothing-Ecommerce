...
function buyNow(title, subtitle, price) {
  // You can optionally store in cart or redirect to checkout
  const item = { title, subtitle, price };
  
  // Example: redirect to a checkout page
  localStorage.setItem('checkoutItem', JSON.stringify(item));
  window.location.href = '../HTML/checkout.html'; // Change to your checkout page
}
